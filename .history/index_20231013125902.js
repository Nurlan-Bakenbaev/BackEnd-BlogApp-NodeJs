...
//user
app.post("/auth/login",handleValidationErrors, loginValidation, UserControllers.login);
app.post("/auth/register",handleValidationErrors, registerValidation, UserControllers.register);
